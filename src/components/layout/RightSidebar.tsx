...
export function RightSidebar() {
  return (
    <aside className="relative z-10 hidden h-full w-[300px] shrink-0 flex-col gap-4 overflow-y-auto border-l border-accent/15 bg-background p-4 scrollbar-thin xl:flex">
