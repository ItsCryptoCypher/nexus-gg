...
export function UpcomingRooms({ rooms }: UpcomingRoomsProps) {
  return (
      ...
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted">
            Scheduled discussions you can set a reminder for
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              aria-label="Scroll upcoming rooms left"
            >
            ...
            <button
              type="button"
              className="flex h-7 w-7 items-center justify-center rounded-lg border border-border-subtle text-muted transition-colors hover:bg-surface-hover hover:text-foreground"
              aria-label="Scroll upcoming rooms right"
            >
