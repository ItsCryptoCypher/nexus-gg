...
import { OpenPartyCard } from "@/components/parties/OpenPartyCard";
import { SectionCard } from "@/components/ui/SectionCard";
import type { OpenParty } from "@/data/mock";

type OpenGamePartiesProps = {
  parties: OpenParty[];
};

export function OpenGameParties({ parties }: OpenGamePartiesProps) {
  return (
      ...
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted">
            Jump into open lobbies looking for players
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              aria-label="Scroll parties left"
            >
            ...
            <button
              type="button"
              className="flex h-7 w-7 items-center justify-center rounded-lg border border-border-subtle text-muted transition-colors hover:bg-surface-hover hover:text-foreground"
              aria-label="Scroll parties right"
            >
